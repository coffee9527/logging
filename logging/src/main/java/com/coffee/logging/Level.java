...
public class Level implements java.io.Serializable{
	...
	final synchronized String getLocalizedLevelName() {
		final String cachedLocalezedName = getCachedLocalizedLevelName();
		if(cachedLocalezedName != null) {
			return cachedLocalezedName;
		}
	...
	static final class KnownLevel {
		...
		static synchronized void add(Level l) {
			...
			List<KnownLevel> list = nameToLevels.get(l);
			if(list == null) {
